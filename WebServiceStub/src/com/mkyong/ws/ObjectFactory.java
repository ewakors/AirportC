...
//        private final static QName _GetAirport_QNAME = new QName("http://ws.mkyong.com/", "getAirport");
//    private final static QName _GetAirportResponse_QNAME = new QName("http://ws.mkyong.com/", "getAirportResponse");
...
//      @XmlElementDecl(namespace = "http://ws.mkyong.com/", name = "getAirport")
//    public JAXBElement<GetAirport> createGetAirport(GetAirport value) {
//        return new JAXBElement<GetAirport>(_GetAirport_QNAME, GetAirport.class, null, value);
//    }
//

//    @XmlElementDecl(namespace = "http://ws.mkyong.com/", name = "getAirportResponse")
//    public JAXBElement<GetAirportResponse> createGetAirportResponse(GetAirportResponse value) {
//        return new JAXBElement<GetAirportResponse>(_GetAirportResponse_QNAME, GetAirportResponse.class, null, value);
//    }
